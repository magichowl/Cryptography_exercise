...
\label{sec:ac}
\subsection{Access control Problem}

Question:

\hspace{1cm}List and briefly define categories of security services.
...
\hspace{1cm} List the common implementation methods of Access control.
...
\hspace{1cm}List four techniques used by firewalls to control access and enforce a security policy.
...
\hspace{1cm}What is the access pattern of a file?
...
\hspace{1cm}Briefly describe the problem of Discretionary Access control and Mandatory Access control.
...
\hspace{1cm} The resource to be protected is defined as an access control packet, and what does the access control packet include?
...
\hspace{1cm} What are the three elements of access control?
...
\hspace{1cm}List three basic principles of Access Control.
...
\hspace{1cm}List the common access control models.
...
\hspace{1cm}Please draw the basic composition of the access control model.
...
\hspace{1cm}Please draw the access control relationship diagram.
...
\label{sec:cip}
\subsection{Confidentiality and integrity policies Problem}

Question:

\hspace{1cm}Describe the classification about Data confidentiality.
...
\hspace{1cm}According to ISO7498-2, what is included in security services?
...
\hspace{1cm}The SSL Record Protocol provides two services for SSL connections, what are they?
...
\hspace{1cm}List the threats about Integrity and Confidentiality, respectively.
...
\hspace{1cm}How do access control technology reflect the confidentiality and integrity?
...
\hspace{1cm}Describe the IP security services, such us RFC4301?
...
\hspace{1cm}What aspects of security do Cryptography provide for the storage and transmission of digital information?
